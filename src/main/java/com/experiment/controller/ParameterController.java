...
public class ParameterController extends BaseController {
    ...
    public Response search(@RequestParam("name")String name){
        return Response.success(parameterService.search(name));
    }
    ...
    public Response delete(@RequestBody Parameter parameter){
        parameterService.delete(parameter.getParameterID());
        return Response.success();
    }
    ...
    @RequiresRoles("管理员")
    @PostMapping("/add")
    public Response add(@RequestBody FormulaParameter  formulaParameter){
        parameterService.add(formulaParameter);
        return Response.success();
    }
